...
| ID         | Input                                               | Existe | Resultado | Motivo           |
| ---------- | --------------------------------------------------- | ------ | --------- | ---------------- |
| F2.1-R1-E1 | [aaron_uziel@live.com](mailto:aaron_uziel@live.com) | No     | Éxito     | -                |
| F2.1-R1-E2 | marcelo_agachateyconocelo.com                       | No     | Error     | Formato inválido |
| F2.1-R2-E1 | [Aaron_uziel@live.com](mailto:Aaron_uziel@live.com) | Sí     | Error     | Email duplicado  |
| F2.1-R1-E3 | aaron_uziel@livecom                                 | No     | Error     | Formato inválido |
...
| ---------- | --------- | --------- | --------------------- |
| F2.2-R2-E1 | asvr@567  | Error     | Falta mayúscula       |
| F2.2-R1-E1 | aB12@     | Error     | Longitud insuficiente |
| F2.2-R4-E1 | 12345asD  | Error     | Falta símbolo         |
| F2.2-R3-E1 | aservA@t  | Error     | Falta número          |
| F2.2-R3-E2 | 12312434@ | Error     | Falta letra           |
...
| ID         | Campo        | Obligatorio | Condición      |
| ---------- | ------------ | ----------- | -------------- |
| F3.1-R2-E1 | Tipo         | Sí          | -              |
| F3.1-R2-E2 | Requisitos   | Sí          | Al menos uno   |
| F3.1-R3-E1 | Fecha límite | Sí          | ≥ hoy + 5 días |
...
| ---------- | ------------- | ---------------------- | ---------------- |
| F3.2-R2-E1 | Disponible    | Fecha límite alcanzada | Cerrado          |
| F3.2-R3-E1 | Cerrado       | Selección postulante   | Finalizado       |
| F3.2-R3-E2 | Cerrado       | Desierta               | Finalizado       |
...
| F4.1-R4-E1 | Postulado     | Fecha límite superada | En revisión      |
| F4.1-R5-E1 | En revisión   | Seleccionado          | Aceptado         |
| F4.1-R5-E2 | En revisión   | No seleccionado       | Rechazado        |
